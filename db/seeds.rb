...
{
content: "集合管における尿の濃縮に関わるホルモンはパラトルモンである。",
answer: "false",
explanation: "【国試ポイント】\n尿濃縮に関与するのはADH。\nパラトルモンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "集合管における尿の濃縮に関わるホルモンはメラトニンである。",
answer: "false",
explanation: "【国試ポイント】\n尿濃縮に関与するのはADH。\nメラトニンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "集合管における尿の濃縮に関わるホルモンはアルドステロンである。",
answer: "true",
explanation: "【国試ポイント】\nアルドステロンはNa再吸収を促進。\n尿量調節に関与する。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "膀胱括約筋はノルアドレナリンの作用で収縮する。",
answer: "true",
explanation: "【国試ポイント】\n交感神経刺激で内尿道括約筋は収縮。\n蓄尿を助ける。",
category: "生理",
subcategory: "内臓",
...
{
content: "食物で胃が伸展されると大腸の蠕動運動が抑制される。",
answer: "false",
explanation: "【国試ポイント】\n胃結腸反射で大腸運動は亢進。\n抑制ではない。",
category: "生理",
subcategory: "内臓",
...
{
content: "集合管における尿の濃縮に関わるホルモンはグルカゴンである。",
answer: "false",
explanation: "【国試ポイント】\n尿濃縮にはADHが関与。\nグルカゴンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "直腸の収縮を促す神経伝達物質はアドレナリンである。",
answer: "false",
explanation: "【国試ポイント】\n排便促進は副交感神経作用。\nアドレナリンではない。",
category: "生理",
subcategory: "内臓",
...
{
content: "腎盤から腎杯へは、尿生成の流れの方向として正しい。",
answer: "false",
explanation: "【国試ポイント】\n尿は腎杯→腎盤→尿管。\n逆方向ではない。",
category: "生理",
subcategory: "内臓",
...
{
content: "排尿を我慢するときには大脳皮質から抑制がかかる。",
answer: "true",
explanation: "【国試ポイント】\n排尿反射は大脳皮質で抑制可能。\n随意的に我慢できる。",
category: "生理",
subcategory: "神経生理",
...
{
content: "尿道から膀胱へは、尿生成の流れの方向として正しい。",
answer: "false",
explanation: "【国試ポイント】\n尿は膀胱→尿道へ流れる。\n逆方向ではない。",
category: "生理",
subcategory: "内臓",
...
{
content: "尿管から髄質部集合管へは、尿生成の流れの方向として正しい。",
answer: "false",
explanation: "【国試ポイント】\n集合管→腎杯→腎盤→尿管。\n逆方向ではない。",
category: "生理",
subcategory: "内臓",
...
{
content: "集合管における尿の濃縮に関わるホルモンはオキシトシンである。",
answer: "false",
explanation: "【国試ポイント】\n尿濃縮にはADHが関与。\nオキシトシンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "代謝当量（MET）は安静臥位時の代謝量を基準とした運動強度である。",
answer: "true",
explanation: "【国試ポイント】\n1METは安静時代謝量。\n運動強度の指標として用いる。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "体温上昇に伴う生体反応として発汗増加がみられる。",
answer: "true",
explanation: "【国試ポイント】\n発汗は熱放散を促進。\n体温調節の基本反応。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "通常歩行（4km/h）の代謝当量（METs）は9〜10METsである。",
answer: "false",
explanation: "【国試ポイント】\n通常歩行は約3METs。\n9〜10METsは高強度運動。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "作業時エネルギー消費量÷安静時エネルギー消費量はエネルギー代謝率の計算式である。",
answer: "false",
explanation: "【国試ポイント】\nRMRは労作代謝量÷基礎代謝量。\n単純な消費量比ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "労作代謝量÷基礎代謝量はエネルギー代謝率の計算式である。",
answer: "true",
explanation: "【国試ポイント】\nRMRの基本計算式。\n国試頻出事項。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "体温上昇に伴う生体反応として気管支収縮がみられる。",
answer: "false",
explanation: "【国試ポイント】\n体温調節とは無関係。\n発汗や皮膚血管拡張が重要。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "基礎代謝量（BM）は同性・同年齢なら体表面積に比例する。",
answer: "false",
explanation: "【国試ポイント】\nこの設問は誤りとして出題。\n基礎代謝量は個体差も大きい。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "エネルギー代謝率（RMR）は基礎代謝量を基準とした運動強度である。",
answer: "false",
explanation: "【国試ポイント】\n運動強度の指標はMET。\nRMRは代謝率を表す。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "通常歩行（4km/h）の代謝当量（METs）は5〜6METsである。",
answer: "false",
explanation: "【国試ポイント】\n通常歩行は約3METs。\n5〜6METsは速歩レベル。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "体温上昇に伴う生体反応として呼吸抑制がみられる。",
answer: "false",
explanation: "【国試ポイント】\n体温上昇では熱放散が促進。\n呼吸抑制ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "内的仕事量÷全仕事量はエネルギー代謝率の計算式である。",
answer: "false",
explanation: "【国試ポイント】\nエネルギー代謝率の計算式ではない。\nRMRの式を覚える。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "同性・同年齢ならば体表面積に比例するのは基礎代謝量である。",
answer: "true",
explanation: "【国試ポイント】\n基礎代謝量は体表面積と関連。\n国試頻出事項。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "通常歩行（4km/h）の代謝当量（METs）は7〜8METsである。",
answer: "false",
explanation: "【国試ポイント】\n通常歩行は約3METs。\n7〜8METsは高強度運動。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "ピルビン酸は嫌気的代謝の過程で生成される物質である。",
answer: "true",
explanation: "【国試ポイント】\n解糖系でピルビン酸が生成。\n嫌気的代謝でも重要。",
category: "生理",
subcategory: "筋生理",
...
{
content: "通常歩行（4km/h）の代謝当量（METs）は1〜2METsである。",
answer: "false",
explanation: "【国試ポイント】\n通常歩行は約3METs。\n1〜2METsは安静に近い。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "作業時代謝量÷安静時代謝量はエネルギー代謝率の計算式である。",
answer: "false",
explanation: "【国試ポイント】\nRMRは労作代謝量÷基礎代謝量。\n安静時代謝量ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "フマル酸は嫌気的代謝の過程で生成される物質である。",
answer: "false",
explanation: "【国試ポイント】\nフマル酸はTCA回路の中間体。\n好気的代謝で重要。",
category: "生理",
subcategory: "筋生理",
...
{
content: "体温上昇に伴う生体反応として皮膚血管収縮がみられる。",
answer: "false",
explanation: "【国試ポイント】\n熱放散のため皮膚血管拡張。\n収縮ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "基礎代謝量（BM）は同性で同年齢ならば体重に比例する。",
answer: "true",
explanation: "【国試ポイント】\n基礎代謝量は体格の影響を受ける。\n体重増加で増える。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "特異動的作用（SDA）とは食物摂取後の体温上昇である。",
answer: "true",
explanation: "【国試ポイント】\nSDA＝食事誘発性熱産生。\n食後に熱産生が増加する。",
category: "生理",
subcategory: "消化",
...
{
content: "基礎代謝量÷基準体表面積はエネルギー代謝率の計算式である。",
answer: "false",
explanation: "【国試ポイント】\nこれは基礎代謝率の計算。\nRMRの計算式ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "特異動的作用（SDA）とは食物摂取後の消費エネルギーの減少である。",
answer: "false",
explanation: "【国試ポイント】\nSDAは消費エネルギー増加。\n減少ではない。",
category: "生理",
subcategory: "消化",
...
{
content: "呼吸商（RQ）は摂取する栄養素によって異なる。",
answer: "true",
explanation: "【国試ポイント】\n糖質1.0、脂質0.7、蛋白0.8。\n栄養素で変化する。",
category: "生理",
subcategory: "呼吸",
...
{
content: "コハク酸は嫌気的代謝の過程で生成される物質である。",
answer: "false",
explanation: "【国試ポイント】\nコハク酸はTCA回路の中間体。\n好気的代謝で重要。",
category: "生理",
subcategory: "筋生理",
...
{
content: "通常歩行（4km/h）の代謝当量（METs）は3〜4METsである。",
answer: "true",
explanation: "【国試ポイント】\n通常歩行は約3METs。\n国試頻出数値。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "呼吸商（RQ）は摂取する栄養素によらず一定である。",
answer: "false",
explanation: "【国試ポイント】\n糖質1.0、脂質0.7、蛋白0.8。\n栄養素で異なる。",
category: "生理",
subcategory: "呼吸",
...
{
content: "代謝当量（METs）は作業時代謝量÷基礎代謝量で表す。",
answer: "false",
explanation: "【国試ポイント】\nMETは安静時代謝量基準。\n基礎代謝量ではない。",
category: "生理",
subcategory: "体温・恒常性",
...
{
content: "クエン酸は嫌気的代謝の過程で生成される物質である。",
answer: "false",
explanation: "【国試ポイント】\nクエン酸はTCA回路の中間体。\n好気的代謝で生成。",
category: "生理",
subcategory: "筋生理",
...
{
content: "食後の消費エネルギー増加は脂質摂取に比べ蛋白質摂取で大きい。",
answer: "true",
explanation: "【国試ポイント】\nSDAは蛋白質が最大。\n脂質より大きい。",
category: "生理",
subcategory: "消化",
...
{
content: "エリスロポエチンの産生を促進するのは血糖値の低下である。",
answer: "false",
explanation: "【国試ポイント】\nEPOは低酸素で分泌増加。\n血糖値低下は直接関係しない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "下垂体前葉で合成されるのは成長ホルモンである。",
answer: "true",
explanation: "【国試ポイント】\n成長ホルモンは下垂体前葉から分泌。\n国試頻出。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "血糖を上昇させる作用のあるホルモンはパラトルモンである。",
answer: "false",
explanation: "【国試ポイント】\nパラトルモンはCa調節。\n血糖上昇はグルカゴンなど。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "グルカゴンはランゲルハンス島B細胞で産生される。",
answer: "false",
explanation: "【国試ポイント】\nグルカゴンはA細胞。\nB細胞はインスリン。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "ゴナドトロピンは分娩後の乳汁分泌に作用するホルモンである。",
answer: "false",
explanation: "【国試ポイント】\n乳汁分泌はプロラクチン。\nゴナドトロピンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "カルシトニンとパラトルモンは同一臓器から分泌される。",
answer: "false",
explanation: "【国試ポイント】\nカルシトニンは甲状腺。\nパラトルモンは副甲状腺。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "排卵を誘発するのは卵胞刺激ホルモン（FSH）の低下である。",
answer: "false",
explanation: "【国試ポイント】\n排卵はLHサージで起こる。\nFSH低下ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "エリスロポエチンの産生を促進するのは動脈血酸素分圧の低下である。",
answer: "true",
explanation: "【国試ポイント】\n低酸素刺激でEPO増加。\n赤血球産生を促進する。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "エリスロポエチンの産生を促進するのは血圧の低下である。",
answer: "false",
explanation: "【国試ポイント】\n主な刺激は低酸素。\n血圧低下ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "血糖を上昇させる作用のあるホルモンはプロラクチンである。",
answer: "false",
explanation: "【国試ポイント】\n血糖上昇はグルカゴンやアドレナリン。\nプロラクチンではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "卵胞刺激ホルモン（FSH）は視床下部から分泌される。",
answer: "false",
explanation: "【国試ポイント】\nFSHは下垂体前葉。\n視床下部ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "血糖を上昇させる作用のあるホルモンはアドレナリンである。",
answer: "true",
explanation: "【国試ポイント】\nグリコーゲン分解促進。\n血糖値を上昇させる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "重炭酸イオンの再吸収を促進するのは副甲状腺ホルモンである。",
answer: "false",
explanation: "【国試ポイント】\nPTHはリン再吸収抑制。\n重炭酸再吸収促進ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "インスリンはグルコースの細胞内取り込みを阻害する。",
answer: "false",
explanation: "【国試ポイント】\nインスリンは細胞内への糖取り込みを促進。\n血糖値を低下させる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "上皮小体ホルモンは血中カルシウム濃度を増加させる。",
answer: "true",
explanation: "【国試ポイント】\nPTHは血中Ca濃度を上昇。\n骨吸収も促進する。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "副甲状腺ホルモンは遠位尿細管でのカルシウム再吸収を抑制する。",
answer: "false",
explanation: "【国試ポイント】\nPTHはCa再吸収を促進。\n尿中排泄を減少させる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "血糖を上昇させる作用のあるホルモンはカルシトニンである。",
answer: "false",
explanation: "【国試ポイント】\nカルシトニンはCa代謝に関与。\n血糖上昇作用はない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "グレリンは下垂体後葉から分泌されるホルモンである。",
answer: "false",
explanation: "【国試ポイント】\nグレリンは胃から分泌。\n食欲を促進する。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "黄体化ホルモンはプロゲステロンの分泌を促進する。",
answer: "true",
explanation: "【国試ポイント】\nLHは黄体形成を促進。\nプロゲステロン分泌を高める。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "排卵を誘発するのは黄体形成ホルモンの上昇である。",
answer: "true",
explanation: "【国試ポイント】\nLHサージが排卵の引き金。\n頻出事項。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "プロラクチンは分娩後の乳汁分泌に作用するホルモンである。",
answer: "true",
explanation: "【国試ポイント】\n乳汁産生を促進。\n下垂体前葉ホルモン。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "小児期の成長ホルモン分泌不全は低身長をきたす。",
answer: "true",
explanation: "【国試ポイント】\nGH欠乏で成長障害。\n低身長の原因となる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "トリヨードサイロニン（T3）は上皮小体で産生される。",
answer: "false",
explanation: "【国試ポイント】\nT3は甲状腺で産生。\n上皮小体ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "オキシトシンとバソプレシンは同一の臓器から分泌される。",
answer: "true",
explanation: "【国試ポイント】\nどちらも下垂体後葉から放出。\nセットで頻出。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "インスリンとグルカゴンは同一の臓器から分泌される。",
answer: "true",
explanation: "【国試ポイント】\nどちらも膵臓ランゲルハンス島。\n細胞は異なる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "エリスロポエチンの産生を促進するのは血中カルシウム濃度の低下である。",
answer: "false",
explanation: "【国試ポイント】\nEPOは低酸素で増加。\nCa濃度は直接関係しない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "エリスロポエチンとレニンは同一の臓器で産生される。",
answer: "true",
explanation: "【国試ポイント】\nどちらも腎臓由来。\n国試でよく問われる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "エリスロポエチンの産生を促進するのは腎機能の低下である。",
answer: "false",
explanation: "【国試ポイント】\n腎機能低下ではEPO産生は減少。\n腎性貧血の原因となる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "アルドステロンとコルチゾールは同一の臓器から分泌される。",
answer: "true",
explanation: "【国試ポイント】\nどちらも副腎皮質由来。\n分泌層は異なる。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "性腺刺激ホルモン放出ホルモン（GnRH）は下垂体から分泌される。",
answer: "false",
explanation: "【国試ポイント】\nGnRHは視床下部ホルモン。\n下垂体ではない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "血糖を上昇させる作用のあるホルモンはアルドステロンである。",
answer: "false",
explanation: "【国試ポイント】\nアルドステロンはNa再吸収。\n血糖上昇作用はない。",
category: "生理",
subcategory: "ホルモン",
...
{
content: "松果体とカルシトニンは正しい内分泌器官とホルモンの組み合わせである。",
answer: "false",
explanation: "【国試ポイント】\nカルシトニンは甲状腺。\n松果体ではない。",
category: "生理",
subcategory: "ホルモン",
